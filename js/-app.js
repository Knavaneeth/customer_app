...
{	
    ...
    $.each( data, function( key, val ) {     
    	 ...
    	 htm+='<ons-list-item modifier="tappable" class="list-item-container product list" onclick="loadRestaurantCategory('+val.merchant_id+');" >';
...
{	
	...
	if (data.has_menu_category==2){		
        ...
        htm += '<div class="swiper-slide" id="'+val.cat_id+'" >'+val.category_name+'</div>';
		});	
