	...
	{		
	  ...
	  case "page-addressbook-details":
	   ...
	   case "page-shipping":	  
		...
		callAjax("search_take_away","type=1&address="+ getStorage("search_address") );	
	    	           ...
	    	           if ( val.offers.length>0){
	    	           	   ...
	    	           	   //	  htm+='<p class="top10">'+val_offer+'</p>';
	    	           		...
	    	           		else
	    	           		{
		    	            	...
		    	            	{
									htm+='<div class="booking-btn" onclick="loadRestaurantCategory('+val.merchant_id+','+rest_logo+','+rest_name+')" > Book a Table </div>';   			
						   		}
					    	}
