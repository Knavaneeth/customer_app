    	          ...
    	          htm+='<p class="cod">'+val.payment_options.cod+'</p>';
	    	           ...
	    	           if ( val.offers.length>0){
	    	           	   ...
	    	           	   //	  htm+='<p class="top10">'+val_offer+'</p>';
	    	           		...
	    	           		{
	    	    				htm+='<div class="booking-btn" onclick="loadRestaurantCategory('+val.merchant_id+','+rest_logo+','+rest_name+')" > View Menu </div>';		       			
	    	           		}
	    	           		else
	    	           		{
		    	            	...
		    	            	{ 
									...
									htm+='<div class="booking-btn" onclick="loadRestaurantCategory('+val.merchant_id+','+rest_logo+','+rest_name+')" > '+btn_txt+' </div>';   			
						   		}
					    	}
...
function displayCart(data)
{
    ...
    var test = formatAMPM(cd);      
    //var ccurrent_year = d.getFullYear(); 
    h = cd.getHours() >= 12 ? 'PM' : 'AM';    
    var minutes = ('0' + cd.getMinutes()).slice(-2); 
    
    $(".delivery_time").val(cd.getHours()+":"+(parseInt(minutes)+1)+" "+h);
...
var minutes = date.getMinutes();  var ampm = hours >= 12 ? 'pm' : 'am';  hours = hours % 12;  hours = hours ? hours : 12; 
...
{	 
	var options = {
      ...
      onTransitionEnd: function() { 	
      	  ...
      	  $(".mobile").attr("placeholder", getTrans('Mobile Number','mobile_number') );
      	  $(".booking_notes").attr("placeholder", getTrans('Your Instructions','your_instructions') );
      	  $('.hidden_merchant_id').val(merchant_id);
      	  translateValidationForm();
